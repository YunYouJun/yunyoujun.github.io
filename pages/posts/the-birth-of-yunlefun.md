...
业余的我很热衷开源事业，自己写过一些开源项目也参与过一些知名的开源项目。
...
也向身边人进行了推荐。商业化固然无可厚非，但难免有种受背刺之感。
...
Fun 则是根域名，代表「有趣」，同时谐音「坊」，我并没有使其成为成熟公司的魄力和把握，所以我将其定位一个小作坊，一个希望能带来快乐和有趣之物的小小工作坊。
...
但似乎并不完全是徒劳无功，在开发它的过程中，我写了一个虚拟摇杆并抽取为示例将其开源了出去，命名为 [cocos-creator-joystick](https://github.com/YunYouJun/cocos-creator-joystick/)。
...
对了，似乎还听过一个臭名昭著的词，KPI 开源。

入职几个月，便在公司充分体会到了加班的痛苦，并了解到一些黑话的含义。
> 比如「不鼓励加班」就是你得干活，但是没有加班费。
...
![想早点离职](https://r2.yunyoujun.cn/images/not-work-chat-with-father.jpg)

趁着国庆期间回了趟家，父亲骑着电动车带我在镇上兜了会儿风。
...
我希望能够参与对其本身的一些设计想法中，去实现一个让人愿意分享的产品。
