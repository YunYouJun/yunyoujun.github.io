...
![添加自己的域名](https://cos.yunle.fun/images/tencent-cloud-add-domain-for-cdn.jpg)

### 设置源站

管理 > 基本配置

![设置源站](https://cos.yunle.fun/images/tencent-cloud-config-source-site.jpg)
...
![回源协议](https://cos.yunle.fun/images/tencent-cloud-set-back-source-protocol.jpg)
...
![设置 CNAME](https://cos.yunle.fun/images/tencent-cloud-set-different-cname-for-domain.jpg)
