...
<template>
  <div class="sponsor-table">
    <div class="sponsor-table">
      <div class="header sponsor-row flex items-center justify-between" m="1">
      ...
      <div v-for="row, i in sponsorStore.expenses" :key="i" class="sponsor-row flex items-center justify-between" p="1" text="xs">
