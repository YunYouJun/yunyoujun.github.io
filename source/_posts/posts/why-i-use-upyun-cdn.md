...
> 对了，它们都有很重要的一点，那就是需要备案。所以你需要先确保的你可以接受实名备案，且你的域名是可以备案的。（即使 `.com`, `.cn` 等主流顶级域名）
...
而又拍云提供的 WebP 自适应功能，无意是我期待的。根据设备来决定返回 JPG 还是 WebP 格式，而我要做的只是把图片托管在又拍云的云存储中。
...
而腾讯云赠送的 CDN 流量则至支持国内加速。又拍云则同样提供了全球加速的选项。
...
此外，因为我潜伏进了又拍云联盟群，参与过一次抽奖活动，幸运地抽到了一个又拍云马克杯。（在家，木有照片）
我也在一些知名的开源项目，譬如 [APlayer](https://github.com/DIYgod/APlayer) 等看到了又拍云的身影。
因此，又拍云给我留下的印象相对不错。
...
这也是我此前一直烦恼的事情，以前的赠送的额度基本绰绰有余，而站点的访问越来越大，似乎有些入不敷出了。而这也算解了我的燃眉之急。
